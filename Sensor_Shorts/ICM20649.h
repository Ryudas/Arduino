 ...
 * #include "ICM20649.h"
 *
 * //Create an ICM20649 object
 * ICM20649 sensor(...);
 *
 * int main()
 * {
 *     //Try to open the ICM20649
 *     if (sensor.open()) {
...
public:
    ...
    /** Create an ICM20649 object connected to the specified SPI pins
     *
     * @param mosi The SPI MOSI pin.
     * @param miso The SPI MISO pin.
     * @param sclk The SPI clock pin.
     * @param cs The SPI Chip Select pin.
     * @param irq The ICM20649 irq pin.
     */
    ICM20649(PinName mosi, PinName miso, PinName sclk, PinName cs, PinName irq = NC);
    ...
    */
    ...
    /** Probe for the ICM20649 and try to initialize the sensor
     *
     * @returns
